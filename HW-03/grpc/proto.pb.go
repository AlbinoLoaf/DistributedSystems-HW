...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x0a,
	0x06, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x41,
	0x63, 0x63, 0x65, 0x70, 0x74, 0x32, 0x4b, 0x0a, 0x02, 0x42, 0x43, 0x12, 0x45, 0x0a, 0x10, 0x42,
	...
	,
...
var file_grpc_proto_proto_goTypes = []interface{}{
	...
	(*Confirmation)(nil),      // 5: ChittyChat.confirmation
}
var file_grpc_proto_proto_depIdxs = []int32{
	0, // 0: ChittyChat.BC.BroadcastMessage:input_type -> ChittyChat.PublishMessage
	4, // 1: ChittyChat.Usermanagement.LeaveClient:input_type -> ChittyChat.Client
	3, // 2: ChittyChat.Usermanagement.ClientJoin:input_type -> ChittyChat.NewClient
	1, // 3: ChittyChat.BC.BroadcastMessage:output_type -> ChittyChat.Broadcast
	5, // 4: ChittyChat.Usermanagement.LeaveClient:output_type -> ChittyChat.confirmation
	4, // 5: ChittyChat.Usermanagement.ClientJoin:output_type -> ChittyChat.Client
