...
const (
	Auction_SendBid_FullMethodName   = "/hw05.Auction/sendBid"
	Auction_RequestId_FullMethodName = "/hw05.Auction/requestId"
)
...
func (c *auctionClient) RequestId(ctx context.Context, in *RequestClientId, opts ...grpc.CallOption) (*ClientId, error) {
	out := new(ClientId)
	err := c.cc.Invoke(ctx, Auction_RequestId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auction_RequestId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auction_RequestId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
