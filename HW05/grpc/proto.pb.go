...
func (x *ClientId) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *RequestClientId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestClientId) ProtoMessage() {}

func (x *RequestClientId) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_proto_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestClientId.ProtoReflect.Descriptor instead.
func (*RequestClientId) Descriptor() ([]byte, []int) {
	return file_grpc_proto_proto_rawDescGZIP(), []int{4}
}

func (x *RequestClientId) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	,
...
var file_grpc_proto_proto_goTypes = []interface{}{
	...
	(*Win)(nil),             // 2: hw05.win
	(*ClientId)(nil),        // 3: hw05.clientId
	(*RequestClientId)(nil), // 4: hw05.requestClientId
}
var file_grpc_proto_proto_depIdxs = []int32{
	0, // 0: hw05.Auction.sendBid:input_type -> hw05.bid
	4, // 1: hw05.Auction.requestId:input_type -> hw05.requestClientId
	0, // 2: hw05.Auction.Redundancy:input_type -> hw05.bid
	1, // 3: hw05.Auction.sendBid:output_type -> hw05.serverReply
	3, // 4: hw05.Auction.requestId:output_type -> hw05.clientId
	1, // 5: hw05.Auction.Redundancy:output_type -> hw05.serverReply
